...
## 安装教程
首先准备一台VPS安装宝塔面板，把环境安装好，php7.0+

然后创建个网站，创建个数据库。

下载V免签php源码并上传到宝塔，解压。

下载地址：https://wwa.lanzous.com/iwW61oedc2f  。



v免签安卓监控端下载地址

下载地址：https://wwa.lanzous.com/iYbYgorfqvi
  ...
  打开网站目录 config/database.php ，设置好您的mysql账号密码。

  导入数据库文件（位于根目录）vmq.sql到您的数据库。

  至此网站搭建完毕，请访问后自行修改配置信息！默认后台账号和密码均为admin
  
  过程的话就很简单，这样的话，V免签网站就可以访问了。



进入之后我们要设置一些东西。上传支付宝和微信的收款二维码！



准备一个安卓手机作为监控端，登录支付宝和微信，最好是小米，华为，oppo这些常见的机型！

然后下载V免签监控apk，在-监控端设置-里面可以下载。
...
### 视频演示:https://www.youtube.com/watch?v=aQjMyKI70wA
